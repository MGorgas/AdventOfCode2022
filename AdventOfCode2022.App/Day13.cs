...
public class Day13
{
	...
	public static void StartDay13_2()
	{
		...
		var part2packageSet = packageSet.SelectMany(i => i).ConcatMultiple(new[] { del1, del2 }).ToList();
...
{
	public static IEnumerable<T> ConcatMultiple<T>(this IEnumerable<T> enumerable, params T[] items)
	{
		return enumerable.ConcatMultiple(items);
	}
}
