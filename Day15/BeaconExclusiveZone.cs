...
using static Day15.BeaconExclusiveZone;

public class BeaconExclusiveZone
{
	public static string filepath = @"C:\Users\Martin\source\repos\AdventOfCode2022\Day15\input.txt";
